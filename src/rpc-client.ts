...
export async function ingestColdStartSession(
  ...
  if (hasApiKey) {
    ...
    // v0.4.34-pre.release.hf3: Use dynamic import (was modRequire("./narrative-queue")).
    // KASOU OpenClaw runs src/index.ts directly; createRequire bypasses tsx's .ts
    // hook, producing MODULE_NOT_FOUND. Dynamic import works in both dist/ and tsx.
