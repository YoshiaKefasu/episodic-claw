...
## <img src="./assets/icons/cog.svg" width="18" alt="" /> なんで TypeScript + Go なの？
...
### <img src="./assets/icons/file-text.svg" width="16" alt="" /> D0 — 生の記憶（Raw Episodes）
...
### <img src="./assets/icons/moon.svg" width="16" alt="" /> D1 — 長期記憶の要約（Sleep Consolidation）
...
## <img src="./assets/icons/rocket.svg" width="18" alt="" /> v0.2.1 で何がヤバくなったのか
...
## <img src="./assets/icons/cpu.svg" width="18" alt="" /> Agent Install Prompt (エージェント用・詳細版)
...
## <img src="./assets/icons/cog.svg" width="18" alt="" /> 設定一覧 (openclaw.plugin.json)
