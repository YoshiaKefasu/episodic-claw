...
## <img src="./assets/icons/cog.svg" width="24" alt="" /> なんで TypeScript + Go なの？
...
## <img src="./assets/icons/workflow.svg" width="24" alt="" /> どうやって動くの？（アーキテクチャ）
...
## <img src="./assets/icons/layers-3.svg" width="24" alt="" /> 記憶の2層構造（D0 / D1）

> **一言でいうと:** D0は「日記の丸写し」、D1は「後から要点だけまとめたノート」。

### <img src="./assets/icons/file-text.svg" width="24" alt="" /> D0 — 生の記憶（Raw Episodes）
...
### <img src="./assets/icons/moon.svg" width="24" alt="" /> D1 — 長期記憶の要約（Sleep Consolidation）
...
### <img src="./assets/icons/zap.svg" width="24" alt="" /> Surprise Scoreって何？
...
## <img src="./assets/icons/rocket.svg" width="24" alt="" /> v0.2.1 で何がヤバくなったのか
...
## <img src="./assets/icons/package.svg" width="24" alt="" /> インストール
...
## <img src="./assets/icons/cpu.svg" width="24" alt="" /> Agent Install Prompt (エージェント用・詳細版)
...
## <img src="./assets/icons/wrench.svg" width="24" alt="" /> 3つのメモリツール
...
## <img src="./assets/icons/cog.svg" width="24" alt="" /> 設定一覧 (openclaw.plugin.json)

v0.2.1から、AIの脳の働きをいじる設定がUIから丸見えになりました。最初はデフォルトで最高に動くように設定してあります。

| キー | デフォルト | 爆発範囲 (いじりすぎるとどうなる？) |
|---|---|---|
| `reserveTokens` | `64000` | **多すぎ:** AIの脳がパンクして今の会話を処理できなくなる。**少なすぎ:** すぐ過去を忘れるポンコツになる。 |
| `recentKeep` | `96` | **多すぎ:** トークンの消費量がエグいことになる。**少なすぎ:** 会話の文脈（流れ）を見失って話が通じなくなる。 |
...
## <img src="./assets/icons/book-open.svg" width="24" alt="" /> 研究的背景
...
## <img src="./assets/icons/user.svg" width="24" alt="" /> 自己紹介
...
### <img src="./assets/icons/heart.svg" width="24" alt="" /> スポンサー
...
## <img src="./assets/icons/scale.svg" width="24" alt="" /> ライセンス
