...
async function main() {
  ...
  assert.equal(pkg.version, "0.3.6-1", "package.json version should be 0.3.6-1");
  assert.equal(manifest.version, "0.3.6-1", "openclaw.plugin.json version should be 0.3.6-1");
  assert.ok(
