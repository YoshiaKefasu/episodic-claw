...
async function main() {
  ...
  assert.equal(pkg.version, "0.4.13", "package.json version should be 0.4.13");
  assert.equal(manifest.version, "0.4.13", "openclaw.plugin.json version should be 0.4.13");
  assert.ok(
