...
## <img src="./assets/icons/cog.svg" width="18" alt="" /> 为什么死磕 TypeScript + Go 双语言？
...
## <img src="./assets/icons/workflow.svg" width="18" alt="" /> 工作原理（这玩意到底怎么运行的？）
...
### <img src="./assets/icons/zap.svg" width="16" alt="" /> Surprise Score（惊吓分）是个啥？
...
## <img src="./assets/icons/rocket.svg" width="18" alt="" /> v0.2.1 到底强在哪里
...
## <img src="./assets/icons/cpu.svg" width="18" alt="" /> 自动安装防呆咒语 (Agent Install Prompt)
...
## <img src="./assets/icons/wrench.svg" width="18" alt="" /> 三大神器（供你或AI调用）
...
## <img src="./assets/icons/cog.svg" width="18" alt="" /> 调参指南 (openclaw.plugin.json)
...
### <img src="./assets/icons/heart.svg" width="16" alt="" /> 要请喝咖啡吗？
