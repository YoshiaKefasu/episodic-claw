...
## <img src="./assets/icons/cog.svg" width="24" alt="" /> 为什么死磕 TypeScript + Go 双语言？
...
## <img src="./assets/icons/workflow.svg" width="24" alt="" /> 工作原理（这玩意到底怎么运行的？）
...
## <img src="./assets/icons/layers-3.svg" width="24" alt="" /> 记忆两层结构（D0 / D1）

> **一句话总结：** D0 是原始的流水账日记，D1 是你事后总结的干货笔记。

### <img src="./assets/icons/file-text.svg" width="24" alt="" /> D0 — 原始情节（Raw Episodes）
...
### <img src="./assets/icons/moon.svg" width="24" alt="" /> D1 — 长期摘要记忆（Sleep Consolidation）
...
### <img src="./assets/icons/zap.svg" width="24" alt="" /> Surprise Score（惊吓分）是个啥？
...
## <img src="./assets/icons/rocket.svg" width="24" alt="" /> v0.2.1 到底强在哪里
...
## <img src="./assets/icons/package.svg" width="24" alt="" /> 安装
...
## <img src="./assets/icons/cpu.svg" width="24" alt="" /> 自动安装防呆咒语 (Agent Install Prompt)
...
## <img src="./assets/icons/wrench.svg" width="24" alt="" /> 三大神器（供你或AI调用）
...
## <img src="./assets/icons/cog.svg" width="24" alt="" /> 调参指南 (openclaw.plugin.json)
...
## <img src="./assets/icons/book-open.svg" width="24" alt="" /> 研究基础 
（保留给懂行的老哥们看的参考文献原文）
...
## <img src="./assets/icons/user.svg" width="24" alt="" /> 关于作者
...
### <img src="./assets/icons/heart.svg" width="24" alt="" /> 要请喝咖啡吗？
...
## <img src="./assets/icons/scale.svg" width="24" alt="" /> 许可证
