...
v0.3.1 把大脑的化学结构敞开给了 UI。如果你非要想改参数，随便，但下场请自行查看。

现在压缩本身已经交给宿主处理，所以老一代 compaction 用的配置项 (`contextThreshold` / `freshTailCount` / `recentKeep`) 这里不再暴露。
