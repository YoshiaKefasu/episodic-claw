...
> (**Special Thanks: lossless-claw**) v0.3.0 中那种“绝对不丢记忆、坏了还能自己修”的变态级抗灾能力（Phase 7 的核心架构），全部是直接从我们的姐妹项目 `lossless-claw` 中移植并吸收过来的。如果不是在那边经历了无数次踩坑与血战，episodic-claw 绝对达不到今天这种完美度。
