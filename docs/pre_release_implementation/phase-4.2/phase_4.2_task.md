...
- [x] 6.3 Refactor [src/index.ts](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/src/index.ts) to export default function [register(api: OpenClawPluginApi)](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/src/index.ts#21-158).
...
- [x] 7.3 Go: Implement [Surprise](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/go/main.go#308-341) endpoint using the `EmbeddingProvider`.
- [x] 7.4 Go: Implement [Ingest](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/src/rpc-client.ts#199-202) endpoint to generate Slug via the `LLMProvider` and write Markdown files.
...
- [x] 8.5 Go: Implement [Rebuild](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/go/main.go#188-293) RPC (scan all [.md](file:///C:/Users/yosia/.gemini/GEMINI.md), re-embed, upsert to Pebble/HNSW).
...
- [x] 8.7 TS: Implement [assemble](file:///d:/GitHub/OpenClaw%20Related%20Repos/openclaw-v2026.3.12/src/context-engine/types.ts#125-135) hook within [registerContextEngine](file:///d:/GitHub/OpenClaw%20Related%20Repos/episodic-claw/tests/test_real_world.ts#38-41) to prepend search results.
...
- [x] TS: [compact()](file:///d:/GitHub/OpenClaw%20Related%20Repos/openclaw-v2026.3.12/src/context-engine/context-engine.test.ts#279-282) 実装 (forceFlush -> 直接セッション読み取り -> watermarkでギャップ検出 -> batchIngest -> 目次生成 -> セッション書き戻し + absIndexリセット -> 診断結果返却)
